...
pub struct StatusPayload {
    ...
    pub setpoint_temperature: u8,
    pub swing: bool,
    pub swing_step: bool,
    pub probe_temperature: u8,
...
impl PayloadBinaryRepr for StatusPayload {
    fn encode(&self) -> [u8; 5] {
        ...
        data[1] = (data[1] & 0b10000000) | self.setpoint_temperature;
        ...
        data[3] = (data[3] & 0b10000001) | (self.probe_temperature << 1);
...
impl FujiFrame {
    ...
    pub fn decode(original_data: [u8; 8]) -> Self {
        let mut data = [0u8; 8];
        for i in 0..original_data.len() {
            data[i] = original_data[i] ^ 0xFF;
        }
